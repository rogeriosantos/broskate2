  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-dark-50 via-white to-primary-50/30'>
      ...
      <section className='relative overflow-hidden'>
        ...
        <div
          className='absolute bottom-0 right-1/4 w-80 h-80 bg-neon/20 rounded-full blur-3xl animate-float'
        ...
        <div className='relative mx-auto max-w-7xl px-4 py-32 sm:px-6 lg:px-8'>
          <div className='text-center'>
            ...
            {/* Main heading */}
            <h1
              className='text-6xl md:text-8xl font-black tracking-tight font-display mb-6 animate-fade-in-up'
              style={{ animationDelay: '0.2s' }}
            >
              <span className='bg-gradient-to-r from-dark-900 via-primary-600 to-neon bg-clip-text text-transparent'>Bro</span>
              <span className='text-dark-900'>Skate</span>
            </h1>

            <p
              className='mx-auto mt-8 max-w-3xl text-xl md:text-2xl text-dark-600 font-medium leading-relaxed animate-fade-in-up'
              style={{ animationDelay: '0.4s' }}
            >
              Connect with your local skateboarding community.
              <span className='bg-gradient-to-r from-primary-600 to-neon bg-clip-text text-transparent font-bold'>
                {' '}
                Discover epic spots
              </span>
            ...
            >
              ...
              <Link href='/spots' onClick={handleGuestBrowseClick} className='btn-outline text-lg px-10 py-4 group'>
        ...
        <div className='relative mx-auto max-w-7xl px-4 py-32 sm:px-6 lg:px-8'>
          <div className='text-center'>
            ...
            <div className='mt-12 flex flex-col sm:flex-row items-center justify-center gap-6'>
              <Link href='/auth/register' className='btn-neon text-lg px-12 py-4 shadow-2xl shadow-neon/25 group'>
                <RocketLaunchIcon className='w-5 h-5 mr-2 group-hover:rotate-12 transition-transform duration-300' />
                Sign Up Free
              </Link>
              <Link
