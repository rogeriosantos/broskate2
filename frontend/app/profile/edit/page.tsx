    ...
    <div className='min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-2xl mx-auto'>
        ...
        <div className='flex items-center mb-8'>
          <Link href={`/users/${profile?.id}`} className='flex items-center text-gray-600 hover:text-gray-900 mr-4'>
        ...
        <div className='bg-white shadow-md rounded-lg p-6'>
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div>
              ...
              />
              <p className='mt-1 text-xs text-gray-500'>Enter a URL to your profile image. We'll support file uploads soon!</p>
            ...
            <div>
              ...
              <div className='mt-1 flex justify-between'>
                ...
                <p className='text-xs text-gray-500 ml-auto'>{formData.bio.length}/500 characters</p>
              </div>
            </div>
            ...
            {/* Favorite Tricks */}
            <div>
              <label className='block text-sm font-medium text-gray-700 mb-3'>Favorite Tricks</label>
              ...
              <div className='space-y-4 mb-4'>
                <div className='grid grid-cols-2 sm:grid-cols-3 gap-2'>
                  {COMMON_TRICKS.map((trick) => (
                    ...
                    >
                      {trick}
                      {formData.favorite_tricks.includes(trick) && <CheckIcon className='w-4 h-4 ml-1' />}
                    </button>
                  ))}
                </div>
              </div>
