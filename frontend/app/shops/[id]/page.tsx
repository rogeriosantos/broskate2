    ...
    return (
      <div className='container mx-auto px-4 py-8'>
        <div className='text-center py-12'>
          ...
          <p className='text-gray-600 mb-6'>{error ? handleApiError(error) : 'This shop could not be found'}</p>
          <Link href='/shops' className='bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors'>
            Browse All Shops
          </Link>
        </div>
      </div>
  ...
  return (
    <div className='container mx-auto px-4 py-8'>
      ...
      <div className='bg-white rounded-lg shadow-md p-8 mb-6'>
        <div className='flex justify-between items-start mb-6'>
          <div>
            ...
            {shop.address && <p className='text-gray-600 flex items-center'>📍 {shop.address}</p>}
          </div>
      ...
      <div className='bg-white rounded-lg shadow-md p-6'>
        ...
        {isAuthenticated ? (
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <button className='bg-blue-600 text-white p-4 rounded-lg hover:bg-blue-700 transition-colors'>Join Shop Community</button>
            <button className='bg-green-600 text-white p-4 rounded-lg hover:bg-green-700 transition-colors'>Check In Here</button>
          </div>
        ) : (
          <div className='text-center py-8'>
            <div className='text-4xl mb-4'>🔒</div>
            <h3 className='text-lg font-semibold mb-2'>Join to unlock community features</h3>
            <p className='text-gray-600 mb-6'>Connect with other skaters, join the shop community, and share your experiences</p>
      ...
      <div className='mt-8'>
        ...
        <Link href='/shops' className='inline-flex items-center text-blue-600 hover:underline'>
          Browse all shops →
        </Link>
      </div>
    </div>
