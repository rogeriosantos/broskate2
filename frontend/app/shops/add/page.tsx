    ...
    <div className='min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-2xl mx-auto'>
        ...
        <div className='flex items-center mb-8'>
          <Link href='/shops' className='flex items-center text-gray-600 hover:text-gray-900 mr-4'>
        ...
        <div className='bg-white shadow-md rounded-lg p-6'>
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div>
              ...
              <p className='text-xs text-gray-500 mb-3'>Adding coordinates helps customers find your shop more easily</p>
        ...
        <div className='mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4'>
          <div className='flex'>
            ...
            <div className='ml-3'>
              <h3 className='text-sm font-medium text-blue-800'>Shop Verification</h3>
              <div className='mt-2 text-sm text-blue-700'>
                <p>
                  Your shop will be reviewed by our team before being visible to all users. This usually takes 24-48 hours. You'll be
