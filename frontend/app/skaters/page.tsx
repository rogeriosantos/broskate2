    ...
    <div className='container mx-auto px-4 py-8'>
      <div className='flex justify-between items-center mb-8'>
        <div>
          ...
          <p className='text-gray-600'>Connect with skaters from around the world</p>
        </div>
      ...
      {users.length === 0 ? (
        <div className='text-center py-12'>
          ...
          <p className='text-gray-600 mb-6'>
            {search || skillLevel || location ? 'Try adjusting your filters to see more skaters' : 'No skaters have signed up yet'}
          </p>
          {!isAuthenticated && (
                    ...
                    <div className='mb-4'>
                      ...
                      <div className='flex flex-wrap gap-1'>
                        ...
                        {user.favorite_tricks.length > 3 && (
                          <span className='text-xs text-gray-500 px-2 py-1'>+{user.favorite_tricks.length - 3} more</span>
                        )}
                      </div>
                    </div>
                  )}
      ...
      {!isAuthenticated && users.length > 0 && (
        <div className='mt-12 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg p-8 text-center'>
          ...
          <p className='text-purple-100 mb-6'>Connect with skaters, share your skills, and discover new spots together</p>
          <div className='space-x-4'>
            <Link href='/auth/register' className='bg-white text-purple-600 px-6 py-3 rounded-lg hover:bg-gray-100 transition-colors'>
              Sign Up Free
            </Link>
            <Link
              href='/auth/login'
