      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-6">
            {error ? handleApiError(error) : 'This spot could not be found'}
          </p>
          <Link 
            href="/spots"
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        {isAuthenticated ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 mb-6">
              View check-ins, photos, and connect with skaters who've been to this spot
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              This spot is rated for {DIFFICULTY_LABELS[spot.difficulty_level].toLowerCase()} level skaters. 
              Make sure you're comfortable with your skills before attempting.
            </p>
          </div>
        </div>
      </div>
