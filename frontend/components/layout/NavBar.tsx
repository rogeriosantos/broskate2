...
import { Bars3Icon, XMarkIcon, MapPinIcon, BuildingStorefrontIcon, UserCircleIcon, UsersIcon, PlusIcon } from '@heroicons/react/24/outline';
      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        <div className='flex justify-between h-16'>
          ...
          <div className='sm:hidden flex items-center'>
            <button type='button' className='text-gray-600 hover:text-gray-900 p-2' onClick={() => setIsMenuOpen(!isMenuOpen)}>
