...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_MAPBOX_TOKEN: process.env.NEXT_PUBLIC_MAPBOX_TOKEN || 'pk.eyJ1Ijoicm9nZXJpb3NhbnRvcyIsImEiOiJjbWU0cGJrN3QwajNjMmpzODJhaGdldGtpIn0.N9l-8X_nrV62P5LR1Gjsxg',
  },
};
